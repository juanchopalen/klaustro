...
class PostSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $post->row->translations()->save(Translation::create([
            'language_id' => 1,
            'key' => 'title',
        ...
        $post = factory(Post::class)->create([
            ...
            'slug' => str_slug('Solaria Vacanze - Hotel booking web application.'),
            'category_id' => 4,
            'user_id' => 1,
        ...
        $post = factory(Post::class)->create([
            ...
            'slug' => str_slug('Whitebeach - Bar Restaurante web application'),
            'category_id' => 4,
            'user_id' => 1,
